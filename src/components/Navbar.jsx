        ...
        <div className={`bg-blue-500 p-4 w-64 ${isOpen ? 'block' : 'hidden'} sm:block`}>
          ...
          <nav className="sm:block items-center">
            <ul className='flex flex-col gap-10 bg-slate-500'>
              ...
              <li className="">
                <Link to="/skills" className="text-white hover:text-gray-200 hover:underline text-3xl" onClick={toggleMenu}>
                  Skills
                </Link>
              </li>
              <li className="">
                <Link to="/projects" className="text-white hover:text-gray-200 hover:underline text-3xl" onClick={toggleMenu}>
                  Projects
                </Link>
              </li>
              <li className="">
                <Link to="/about" className="text-white hover:text-gray-200 hover:underline text-3xl" onClick={toggleMenu}>
                  About
                </Link>
              </li>
              <li className="">
                <Link to="/contact" className="text-white hover:text-gray-200 hover:underline text-3xl" onClick={toggleMenu}>
                  Contact
                </Link>
              </li>
